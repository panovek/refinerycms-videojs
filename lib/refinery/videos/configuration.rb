module Refinery
  module Videos
    ...
    config_accessor :dragonfly_secret, :dragonfly_url_format,
                    ...
                    :enable_postprocess, :video_encoder_profile
    ...
    self.whitelisted_mime_types = Refinery::Videos.whitelisted_mime_types || %w(video/mp4 video/x-flv application/ogg video/webm video/flv video/ogg video/avi video/quicktime)
    ...
    self.video_encoder_profile = Refinery::Videos.video_encoder_profile || :mp4
